...
@Component({
  standalone: true,
  selector: 'app-site-shift-template-edit',
  templateUrl: './site-shift-template-edit.component.html',
  styleUrls: ['./site-shift-template-edit.component.scss'],
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
...
export class SiteShiftTemplateEditComponent implements OnInit {
